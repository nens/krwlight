...
- Fill in a short description on https://github.com/nens/krwlight if you
...
- Check https://github.com/nens/krwlight/settings/collaboration if the teams
...
- Add a new jenkins job at
  ...
  be "krwlight", make the project a copy of the existing "wro" (for
  instance) project. On the next page, change the "github project" to
  ``https://github.com/nens/krwlight/`` and
  "repository url" fields to ``git@github.com:nens/krwlight.git``. The rest
